...
// 显示登录页
- (void)showLogin {
    BaseNavigationViewController *navi = [[BaseNavigationViewController alloc] initWithRootViewController:self.loginVC];
    [self.homeVC presentViewController:navi animated:YES completion:nil];
